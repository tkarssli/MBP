...
public final class BudgetsContract {
    ...
    public static abstract class Expenses implements BaseColumns {
        ...
        public static final String COLUMN_NAME_EXPENSE_ID       = "entryId";
        public static final String COLUMN_NAME_BUDGET_ID        = Budgets.COLUMN_NAME_BUDGET_ID;
        public static final String COLUMN_NAME_STORE_ID         = Stores.COLUMN_NAME_STORE_ID;
    ...
    private static final String _ID             = _INT + " UNIQUE ";
    ...
    protected static final String MAKE_BUDGETS_TABLE =
        _CREATE_TABLE + Budgets.TABLE_NAME + " ( " +
            Budgets._ID                         + _PRIMARY_KEY  + ", " +
            Budgets.COLUMN_NAME_BUDGET_ID       + _ID           + ", " +
    ...
    protected static final String MAKE_STORES_TABLE =
        _CREATE_TABLE + Stores.TABLE_NAME + " ( " +
            Stores._ID                  + _PRIMARY_KEY  + ", " +
            Stores.COLUMN_NAME_STORE_ID + _ID           + ", " +
            Stores.COLUMN_NAME_NAME     + _TEXT         + ", " +
        ");";

    protected static final String MAKE_EXPENSES_TABLE =
        _CREATE_TABLE + Expenses.TABLE_NAME + " ( " +
            Expenses._ID                        + _PRIMARY_KEY  + ", " +
            Expenses.COLUMN_NAME_EXPENSE_ID     + _ID           + ", " +
